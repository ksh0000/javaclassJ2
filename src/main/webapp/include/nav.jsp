...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <a class="navbar-brand" href="http://192.168.50.52:9090/javaclass/Main">Home</a>
	      ...
	      <li class="nav-item mr-2">
				  <div class="dropdown">
				    ...
				    <div class="dropdown-menu">
				      ...
				      <a class="dropdown-item" href="${ctp}/test/test.jsp" target="_blank">새 창 열기</a>
				    </div>
				  </div>
	      </li>
	      <li class="nav-item mr-2">
				  <div class="dropdown">
				    ...
				    <div class="dropdown-menu">
				      ...
				      <a class="dropdown-item" href="${ctp}/test/testSet.jsp" target="_blank">새 창 열기</a>
				    </div>
				  </div>
	      </li>
      </c:if>
