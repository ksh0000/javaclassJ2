...
<head>
  ...
  <title>freeUpdate.jsp.jsp</title>
...
<div class="container">
  ...
  <form name="myform" method="post" action="FreeUpdateOk.fr">
    <table class="table table-bordered">
      ...
      <tr>
        <td colspan="2" class="text-center">
          ...
          <input type="button" value="돌아가기" onclick="location.href='FreeContent.fr?idx=${vo.idx}&pag=${pag}&pageSize=${pageSize}';" class="btn btn-info"/>
        </td>
      </tr>
    </table>
